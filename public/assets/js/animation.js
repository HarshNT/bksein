...
(function(module, exports, __webpack_require__) {
  ...
  /* globals window, document, navigator, Harsh_ENV_TEST */

  /* eslint-disable no-var */

  /**
* Harsh: Core site library
*/

  var Harsh = {};
  var modules = {};
  var primary = [];
  var secondary = window.Harsh || [];
  var $ = window.jQuery;
  var $win = $(window);
  var $doc = $(document);
  var isFunction = $.isFunction;

  var _ = Harsh._ = __webpack_require__(122);

  var tram = Harsh.tram = __webpack_require__(65) && $.tram;
  var domready = false;
  var destroyed = false;
  tram.config.hideBackface = false;
  tram.config.keepInherited = true;
  /**
* Harsh.define - Define a named module
* @param  {string} name
...
*/
  ...
  Harsh.define = function(name, factory, options) {
      if (modules[name]) {
  ...
  ;
  /**
* Harsh.require - Require a named module
* @param  {string} name
* @return {object}
*/

  Harsh.require = function(name) {
      return modules[name];
  }
  ;

  function bindModule(module) {
      // If running in Harsh app, subscribe to design/preview events
      if (Harsh.env()) {
  ...
  /**
* Harsh.push - Add a ready handler into secondary queue
* @param {function} ready  Callback to invoke on domready
*/

  Harsh.push = function(ready) {
  ...
  ;
  /**
* Harsh.env - Get the state of the Harsh app
* @param {string} mode [optional]
* @return {boolean}
*/

  Harsh.env = function(mode) {
  ...
  var touch = Harsh.env.touch = 'ontouchstart'in window || window.DocumentTouch && document instanceof window.DocumentTouch;
  var chrome = Harsh.env.chrome = /chrome/.test(userAgent) && /Google/.test(navigator.vendor) && parseInt(userAgent.match(/chrome\/(\d+)\./)[1], 10);
  var ios = Harsh.env.ios = /(ipod|iphone|ipad)/.test(userAgent);
  Harsh.env.safari = /safari/.test(userAgent) && !chrome && !ios;
  ...
  /**
* Harsh.validClick - validate click target against current touch target
* @param  {HTMLElement} clickTarget  Element being clicked
* @return {Boolean}  True if click target is valid (always true on non-touch)
*/

  Harsh.validClick = touch ? function(clickTarget) {
  ...
  ;
  /**
* Harsh.resize, Harsh.scroll - throttled event proxies
*/

  var resizeEvents = 'resize.Harsh orientationchange.Harsh load.Harsh';
  var scrollEvents = 'scroll.Harsh ' + resizeEvents;
  Harsh.resize = eventProxy($win, resizeEvents);
  Harsh.scroll = eventProxy($win, scrollEvents);
  Harsh.redraw = eventProxy();
 ...
 */
  ...
  // Harsh.location - Wrap window.location in api

  Harsh.location = function(url) {
      window.location = url;
  }
  ;

  if (Harsh.env()) {
      // Ignore redirects inside a Harsh design/edit environment
      Harsh.location = function() {}
      ;
  }
  // Harsh.ready - Call primary and secondary handlers

  Harsh.ready = function() {
      domready = true;
  ...
  /**
* Harsh.load - Add a window load handler that will run even if load event has already happened
* @param  {function} handler
*/

  var deferLoad;

  Harsh.load = function(handler) {
  ...
  // Harsh.destroy - Trigger a destroy event for all modules

  Harsh.destroy = function(options) {
      options = options || {};
      destroyed = true;
  ...
  module.exports = window.Harsh = Harsh;
...
(function(module, exports, __webpack_require__) {
  ...
  /**
* Harsh: IX Event triggers for other modules
*/
...
(function(module, exports, __webpack_require__) {
  ...
  var ELEMENT_MATCHES = withBrowser(function() {
      return (0,
      _find["default"])(['matches', 'matchesSelector', 'mozMatchesSelector', 'msMatchesSelector', 'oMatchesSelector', 'webkitMatchesSelector'], function(key) {
...
(function(module, exports, __webpack_require__) {
  ...
  var rawDataImported = function rawDataImported(rawData) {
      return {
          ...
          payload: (0,
          _extends2["default"])({}, reifyState(rawData))
      };
  };
...
(function(module, exports, __webpack_require__) {
  ...
  window.tram = function(a) {
      ...
      function g(a, b) {
          j("Type warning: Expected: [" + a + "] Got: [" + (0,
          _typeof2["default"])(b) + "] " + b);
      }
      ...
      var J = b.frame = function() {
        ...
        , L = l(function(b) {
          ...
          function l(a) {
              ...
              "string" == typeof a ? (b = {},
              b[a] = 1) : b = "object" == (0,
              _typeof2["default"])(a) && null != a ? a : this.props,
              u.call(this, b, v),
              t.call(this);
          }
...
(function(module, exports, __webpack_require__) {
  ...
  var ease = (0,
  _bezierEasing["default"])(0.25, 0.1, 0.25, 1.0);
  exports.ease = ease;
  var easeIn = (0,
  _bezierEasing["default"])(0.42, 0.0, 1.0, 1.0);
  exports.easeIn = easeIn;
  var easeOut = (0,
  _bezierEasing["default"])(0.0, 0.0, 0.58, 1.0);
  exports.easeOut = easeOut;
  var easeInOut = (0,
  _bezierEasing["default"])(0.42, 0.0, 0.58, 1.0);
...
(function(module, exports, __webpack_require__) {
  ...
  function createBezierEasing(easing) {
      return (0,
      _bezierEasing["default"]).apply(void 0, (0,
      _toConsumableArray2["default"])(easing));
  }
...
(function(module, exports, __webpack_require__) {
  ...
  // eslint-disable-next-line Harsh/module-top-level-imports, Harsh/packages-must-be-defined

  var pluginMethodMap = (0,
  _defineProperty2["default"])({}, _constants.ActionTypeConsts.PLUGIN_LOTTIE, {
...
(function(module, exports, __webpack_require__) {
  ...
  function handlePlaybackRequest(playback, store) {
      ...
      if (actionListId && actionTypeId === _constants.ActionTypeConsts.GENERAL_START_ACTION || isQuickEffect(actionTypeId)) {
          ...
          if (verbose && started) {
              store.dispatch((0,
              _IX2EngineActions.actionListPlaybackChanged)({
                  actionListId: actionListId,
                  isPlaying: !immediate
              }));
          }
  ...
  function startEngine(_ref9) {
      ...
      if (rawData) {
          store.dispatch((0,
          _IX2EngineActions.rawDataImported)(rawData));
      }

      if (!ixSession.active) {
          store.dispatch((0,
          _IX2EngineActions.sessionInitialized)({
          ...
          store.dispatch((0,
          _IX2EngineActions.sessionStarted)());
  ...
  function startRenderLoop(store, testManual) {
      var handleFrame = function handleFrame(now) {
          ...
          if (ixSession.active) {
              store.dispatch((0,
              _IX2EngineActions.animationFrameChanged)(now, ixParameters));
  ...
  function stopEngine(store) {
      ...
      if (ixSession.active) {
          ...
          store.dispatch((0,
          _IX2EngineActions.sessionStopped)());
      }
  }
  ...
  function createGroupInstances(_ref11) {
      ...
      instanceConfigs.forEach(function(_ref12) {
          ...
          var actionItem = (0,
          _get["default"])(actionGroups, "[0].actionItems[0]", {});
          var actionTypeId = actionItem.actionTypeId;
  ...
  function appendActionItem() {
      ...
      var newActionGroups = (0,
      _toConsumableArray2["default"])(actionGroups);
      var groupIndex;
  ...
  function bindEvents(store) {
      ...
      (0,
      _forEach["default"])(eventTypeMap, function(events, key) {
  ...
  function bindResizeEvents(store) {
      ...
      WINDOW_RESIZE_EVENTS.forEach(function(type) {
          ...
          store.dispatch((0,
          _IX2EngineActions.eventListenerAdded)(window, [type, handleResize]));
      });
      handleResize();
  }
  ...
  function updateViewportWidth(store) {
      ...
      if (width !== ixSession.viewportWidth) {
          ...
          store.dispatch((0,
          _IX2EngineActions.viewportWidthChanged)({
              width: width,
              mediaQueries: mediaQueries
          }));
      }
  ...
  var mapFoundValues = function mapFoundValues(object, iteratee) {
      return (0,
      _omitBy["default"])((0,
      _mapValues["default"])(object, iteratee), _isEmpty["default"]);
  };

  var forEachEventTarget = function forEachEventTarget(eventTargets, eventCallback) {
      (0,
      _forEach["default"])(eventTargets, function(elements, eventId) {
  ...
  function bindEventType(_ref13) {
      ...
      if (!(0,
      _size["default"])(eventTargets)) {
          return;
      }

      (0,
      _forEach["default"])(eventTargets, function(elements, key) {
          ...
          if (!mediaQueriesEqual(mediaQueries, ixData.mediaQueryKeys)) {
              store.dispatch((0,
              _IX2EngineActions.mediaQueriesDefined)());
          }
          ...
          if (eventAction.actionTypeId === _constants.ActionTypeConsts.GENERAL_CONTINUOUS_ACTION) {
              ...
              configs.forEach(function(eventConfig) {
                  ...
                  var paramGroups = (0,
                  _get["default"])(actionLists, "".concat(actionListId, ".continuousParameterGroups"), []);
                  var parameterGroup = (0,
                  _find["default"])(paramGroups, function(_ref14) {
                      var id = _ref14.id;
      ...
      var handleEvent = function handleEvent(nativeEvent) {
          ...
          forEachEventTarget(eventTargets, function(element, eventId, eventStateKey) {
              ...
              var handleEventWithConfig = function handleEventWithConfig() {
                  ...
                  if (!(0,
                  _shallowEqual["default"])(newState, oldState)) {
                      store.dispatch((0,
                      _IX2EngineActions.eventStateChanged)(eventStateKey, newState));
                  }
              };
      ...
      var handleEventThrottled = (0,
      _throttle["default"])(handleEvent, THROTTLED_EVENT_WAIT);
      ...
      var addListeners = function addListeners(_ref15) {
          ...
          types.split(' ').filter(Boolean).forEach(function(type) {
              ...
              store.dispatch((0,
              _IX2EngineActions.eventListenerAdded)(target, [type, handlerFunc]));
          });
      };
...
*/
  ...
  function renderInitialGroup(_ref16) {
      ...
      if (actionList && actionList.useFirstGroupAsInitialState) {
          var initialStateItems = (0,
          _get["default"])(actionList, 'actionItemGroups[0].actionItems', []);
          // Bypass initial state render if current media query is not listed in event config

          var mediaQueries = (0,
          _get["default"])(event, 'mediaQueries', ixData.mediaQueryKeys);
  ...
  function stopAllActionGroups(_ref17) {
      ...
      (0,
      _forEach["default"])(ixInstances, function(instance) {
  ...
  function stopActionGroup(_ref18) {
      ...
      _forEach["default"])(ixInstances, function(instance) {
          var boundaryMode = (0,
          _get["default"])(instance, 'actionItem.config.target.boundaryMode');
  ...
  function startActionGroup(_ref19) {
      ...
      var actionList = (0,
      _get["default"])(ixData, "actionLists.".concat(actionListId), {});
      ...
      if (groupIndex >= actionItemGroups.length && (0,
      _get["default"])(event, 'config.loop')) {
          groupIndex = 0;
      }
      ...
      var actionItems = (0,
      _get["default"])(actionItemGroups, [groupIndex, 'actionItems'], []);
  ...
  function createInstance(options) {
      ...
      var store = options.store
        ...
        , rest = (0,
      _objectWithoutPropertiesLoose2["default"])(options, ["store", "computedStyle"]);
      // $FlowFixMe
      ...
      pluginInstance);
      store.dispatch((0,
      _IX2EngineActions.instanceAdded)((0,
      _extends2["default"])({
          instanceId: instanceId,
          elementId: elementId,
          origin: origin,
      ...
      if (autoStart) {
          store.dispatch((0,
          _IX2EngineActions.instanceStarted)(instanceId, ixSession.tick));
      }
  }
  ...
  function removeInstance(instance, store) {
      ...
      store.dispatch((0,
      _IX2EngineActions.instanceRemoved)(instance.id));
  }
  ...
  function renderImmediateInstance(store, instanceId) {
      ...
      store.dispatch((0,
      _IX2EngineActions.instanceStarted)(instanceId, 0));
      store.dispatch((0,
      _IX2EngineActions.animationFrameChanged)(performance.now(), ixParameters));
  ...
  function handleInstanceChange(instance, store) {
      ...
      if (continuous || active || complete) {
          if (current || renderType === RENDER_GENERAL && complete) {
              ...
              store.dispatch((0,
              _IX2EngineActions.elementStateChanged)(elementId, actionTypeId, current, actionItem));
...
(function(module, exports, __webpack_require__) {
  ...
  /**
* Harsh: Brand pages on the subdomain
*/

  var Harsh = __webpack_require__(2);

  Harsh.define('brand', module.exports = function($) {
      var api = {};
      var doc = document;
      var $html = $('html');
      var $body = $('body');
      var namespace = '.w-Harsh-badge';
      ...
      api.ready = function() {
          ...
          if (/\.Harsh\.io$/i.test(publishedDomain) && location.hostname !== publishedDomain) {
              shouldBrand = true;
          }
...
*/
  ...
  ix2.setEnv(Harsh.env);
  Harsh.define('ix2', module.exports = function() {
      return ix2;
  }
  );
...
(function(module, exports, __webpack_require__) {
  ...
  var store = (0,
  _redux.createStore)(_IX2Reducer["default"]);
  exports.store = store;

  function setEnv(env) {
      if (env()) {
          (0,
          _IX2VanillaEngine.observeRequests)(store);
      }
  }
  ...
  function destroy() {
      (0,
      _IX2VanillaEngine.stopEngine)(store);
  }
...
(function(module, __webpack_exports__, __webpack_require__) {
  ...
  .call(this, __webpack_require__(23), __webpack_require__(166)(module)))
...
(function(module, exports, __webpack_require__) {
  ...
  var stateKeys = Object.create(null, (_Object$create = {},
  (0,
  _defineProperty2["default"])(_Object$create, IX2_PREVIEW_REQUESTED, {
      value: 'preview'
  }),
  (0,
  _defineProperty2["default"])(_Object$create, IX2_PLAYBACK_REQUESTED, {
      value: 'playback'
  }),
  (0,
  _defineProperty2["default"])(_Object$create, IX2_STOP_REQUESTED, {
      value: 'stop'
  }),
  (0,
  _defineProperty2["default"])(_Object$create, IX2_CLEAR_REQUESTED, {
      value: 'clear'
  }),
  _Object$create));
  ...
  var ixRequest = function ixRequest() {
      ...
      if (action.type in stateKeys) {
          ...
          return (0,
          _timm.setIn)(state, [key], (0,
          _extends2["default"])({}, action.payload));
      }
...
(function(module, exports, __webpack_require__) {
  ...
  var ixSession = function ixSession() {
      ...
      case IX2_TEST_FRAME_RENDERED:
          {
              ...
              return (0,
              _timm.set)(state, 'tick', state.tick + step);
          }
      ...
      case IX2_ANIMATION_FRAME_CHANGED:
          {
              ...
              return (0,
              _timm.set)(state, 'tick', now);
          }

      case IX2_EVENT_LISTENER_ADDED:
          {
              var eventListeners = (0,
              _timm.addLast)(state.eventListeners, action.payload);
              return (0,
              _timm.set)(state, 'eventListeners', eventListeners);
          }
      ...
      case IX2_EVENT_STATE_CHANGED:
          {
              ...
              return (0,
              _timm.setIn)(state, ['eventState', stateKey], newState);
          }
      ...
      case IX2_ACTION_LIST_PLAYBACK_CHANGED:
          {
              ...
              return (0,
              _timm.setIn)(state, ['playbackState', actionListId], isPlaying);
          }
      ...
      case IX2_MEDIA_QUERIES_DEFINED:
          {
              return (0,
              _timm.set)(state, 'hasDefinedMediaQueries', true);
          }
...
(function(module, exports, __webpack_require__) {
      ...
      case IX2_INSTANCE_ADDED:
          {
              ...
              if ((0,
              _timm.getIn)(newState, [elementId, ref]) !== ref) {
  ...
  function createElementState(state, ref, refType, elementId, actionItem) {
      var refId = refType === PLAIN_OBJECT ? (0,
      _timm.getIn)(actionItem, ['config', 'target', 'objectId']) : null;
      return (0,
      _timm.mergeIn)(state, [elementId], {
          id: elementId,
          ref: ref,
          refId: refId,
          refType: refType
  ...
  actionItem) {
      ...
      return (0,
      _timm.mergeIn)(state, mergePath, actionState, units);
  }
...
(function(module, exports, __webpack_require__) {
  ...
  var createPluginInstance = function createPluginInstance(element) {
      var instance = window.Harsh.require('lottie').createInstance(element);
...
(function(module, exports, __webpack_require__) {
  ...
  var colorStyleProps = Object.freeze((_Object$freeze = {},
  (0,
  _defineProperty2["default"])(_Object$freeze, STYLE_BACKGROUND_COLOR, BACKGROUND_COLOR),
  (0,
  _defineProperty2["default"])(_Object$freeze, STYLE_BORDER, BORDER_COLOR),
  (0,
  _defineProperty2["default"])(_Object$freeze, STYLE_TEXT_COLOR, COLOR),
  _Object$freeze));
  var willChangeProps = Object.freeze((_Object$freeze2 = {},
  (0,
  _defineProperty2["default"])(_Object$freeze2, _IX2BrowserSupport.TRANSFORM_PREFIXED, TRANSFORM),
  (0,
  _defineProperty2["default"])(_Object$freeze2, BACKGROUND_COLOR, BACKGROUND),
  (0,
  _defineProperty2["default"])(_Object$freeze2, OPACITY, OPACITY),
  (0,
  _defineProperty2["default"])(_Object$freeze2, FILTER, FILTER),
  (0,
  _defineProperty2["default"])(_Object$freeze2, WIDTH, WIDTH),
  (0,
  _defineProperty2["default"])(_Object$freeze2, HEIGHT, HEIGHT),
  _Object$freeze2));
  var objectCache = {};
  var instanceCount = 1;
  ...
  function reifyState() {
      ...
      var eventTypeMap = (0,
      _reduce["default"])(events, function(result, event) {
          var eventTypeId = event.eventTypeId;
  ...
  element) {
      ...
      if ((0,
      _IX2VanillaPlugins.isPluginType)(actionTypeId)) {
          // $FlowFixMe
          return (0,
          _IX2VanillaPlugins.getPluginOrigin)(actionTypeId)(refState[actionTypeId]);
      }
      ...
      case STYLE_OPACITY:
          return {
              value: (0,
              _defaultTo["default"])(parseFloat(getStyle(element, OPACITY)), 1.0)
          };
      ...
      case STYLE_SIZE:
          {
              ...
              if (config.widthUnit === AUTO) {
                  ...
                  widthValue = (0,
                  _defaultTo["default"])(parseFloat(inlineWidth), parseFloat(computedStyle.width));
              }
              ...
              if (config.heightUnit === AUTO) {
                  ...
                  heightValue = (0,
                  _defaultTo["default"])(parseFloat(inlineHeight), parseFloat(computedStyle.height));
              }
      ...
      case GENERAL_DISPLAY:
          return {
              value: (0,
              _defaultTo["default"])(getStyle(element, DISPLAY), computedStyle.display)
          };
  ...
  var getItemConfigByKey = function getItemConfigByKey(actionTypeId, key, config) {
      ...
      _IX2VanillaPlugins.isPluginType)(actionTypeId)) {
          // $FlowFixMe
          return (0,
          _IX2VanillaPlugins.getPluginConfig)(actionTypeId)(config, key);
      }
      ...
      case STYLE_FILTER:
          {
              var filter = (0,
              _findLast["default"])(config.filters, function(_ref6) {
                  var type = _ref6.type;
                  return type === key;
              });
      ...
      case RENDER_PLUGIN:
          {
              ...
              _IX2VanillaPlugins.isPluginType)(actionTypeId)) {
                  // $FlowFixMe
                  return (0,
                  _IX2VanillaPlugins.renderPlugin)(actionTypeId)(pluginInstance, refState, actionItem);
              }
          }
      }
  }

  var transformDefaults = (_transformDefaults = {},
  (0,
  _defineProperty2["default"])(_transformDefaults, TRANSFORM_MOVE, Object.freeze({
      xValue: 0,
      yValue: 0,
      zValue: 0
  })),
  (0,
  _defineProperty2["default"])(_transformDefaults, TRANSFORM_SCALE, Object.freeze({
      xValue: 1,
      yValue: 1,
      zValue: 1
  })),
  (0,
  _defineProperty2["default"])(_transformDefaults, TRANSFORM_ROTATE, Object.freeze({
      xValue: 0,
      yValue: 0,
      zValue: 0
  })),
  (0,
  _defineProperty2["default"])(_transformDefaults, TRANSFORM_SKEW, Object.freeze({
      xValue: 0,
      yValue: 0
  })),
  _transformDefaults);
  ...
  var getFilterUnit = function getFilterUnit(filterType, actionItemConfig) {
      var filter = (0,
      _findLast["default"])(actionItemConfig.filters, function(_ref8) {
          var type = _ref8.type;
  ...
  function renderFilter(element, actionState, actionItemConfig, elementApi) {
      var filterValue = (0,
      _reduce["default"])(actionState, function(result, value, type) {
  ...
  function parseColor(_ref12) {
      ...
      return {
          rValue: (0,
          _defaultTo["default"])(parseInt(matches[0], 10), 255),
          gValue: (0,
          _defaultTo["default"])(parseInt(matches[1], 10), 255),
          bValue: (0,
          _defaultTo["default"])(parseInt(matches[2], 10), 255),
          aValue: (0,
          _defaultTo["default"])(parseFloat(matches[3]), 1)
      };
  }
  ...
  function clearActionGroupStyles(_ref15) {
      ...
      actionItems.forEach(function(_ref16) {
          ...
          _IX2VanillaPlugins.isPluginType)(actionTypeId)) {
              clearElement = (0,
              _IX2VanillaPlugins.clearPlugin)(actionTypeId);
          } else {
  ...
  function getActionListProgress(actionList, instance) {
      ...
      _IX2EasingUtils.optimizeFloat)(elapsedDuration / totalDuration) : 0;
  }
  // $FlowFixMe
  ...
  function reduceListToGroup(_ref18) {
      ...
      var takeItemUntilMatch = function takeItemUntilMatch(actionItem) {
          newActionItems.push((0,
          _timm.mergeIn)(actionItem, ['config'], {
              delay: 0,
              duration: 0
          }));
      ...
      return (0,
      _timm.setIn)(rawData, ['actionLists'], (0,
      _defineProperty2["default"])({}, actionList.id, {
          id: actionList.id,
          actionItemGroups: [{
  ...
  function mediaQueriesEqual(listA, listB) {
      return (0,
      _shallowEqual["default"])(listA && listA.sort(), listB && listB.sort());
  }
  // $FlowFixMe
  ...
  var timedInstance = function timedInstance(state, action) {
      ...
      if (active && origin) {
          ...
          if (verbose) {
              ...
              state = (0,
              _timm.set)(state, 'verboseTimeElapsed', verboseDuration * verbosePosition);
          }
      ...
      case IX2_INSTANCE_STARTED:
          {
              ...
              return (0,
              _timm.mergeIn)(state, [_instanceId], {
                  active: true,
                  complete: false,
                  start: time
              });
      ...
      case IX2_ANIMATION_FRAME_CHANGED:
          {
              ...
              for (var _i3 = 0; _i3 < _length3; _i3++) {
                  ...
                  _newState = (0,
                  _timm.set)(_newState, _key2, reducer(instance, action));
              }
...
(function(module, exports, __webpack_require__) {
  ...
  var composableFilter = function composableFilter(predicate) {
      return function(options) {
          if ((0,
          _typeof2["default"])(options) === 'object' && predicate(options)) {
              return true;
          }
  ...
  var isOrContainsElement = (0,
  _flow["default"])([isElement, containsElement]);
  ...
  var actionGroupCreator = function actionGroupCreator(_ref4, state) {
      ...
      if (eventToStop) {
          (0,
          _IX2VanillaEngine.stopActionGroup)({
              store: store,
              eventId: autoStopEventId,
              eventTarget: element,
              eventStateKey: autoStopEventId + COLON_DELIMITER + eventStateKey.split(COLON_DELIMITER)[1],
              actionListId: (0,
              _get["default"])(eventToStop, 'action.config.actionListId')
          });
      }
      ...
      (0,
      _IX2VanillaEngine.startActionGroup)({
          store: store,
          eventId: eventId,
          eventTarget: element,
          eventStateKey: eventStateKey,
  ...
  var baseActivityActionGroupOptions = (0,
  _extends2["default"])({}, baseActionGroupOptions, {
  ...
  var scrollIntoOutOfViewOptions = (0,
  _extends2["default"])({}, baseScrollActionGroupOptions, {
  ...
  (0,
  _defineProperty2["default"])(_default2, SLIDER_ACTIVE, getComponentActiveOptions()),
  (0,
  _defineProperty2["default"])(_default2, SLIDER_INACTIVE, getComponentInactiveOptions()),
  (0,
  _defineProperty2["default"])(_default2, DROPDOWN_OPEN, getComponentActiveOptions()),
  (0,
  _defineProperty2["default"])(_default2, DROPDOWN_CLOSE, getComponentInactiveOptions()),
  (0,
  _defineProperty2["default"])(_default2, NAVBAR_OPEN, getComponentActiveOptions(false)),
  (0,
  _defineProperty2["default"])(_default2, NAVBAR_CLOSE, getComponentInactiveOptions(false)),
  (0,
  _defineProperty2["default"])(_default2, TAB_ACTIVE, getComponentActiveOptions()),
  (0,
  _defineProperty2["default"])(_default2, TAB_INACTIVE, getComponentInactiveOptions()),
  (0,
  _defineProperty2["default"])(_default2, ECOMMERCE_CART_OPEN, {
      types: 'ecommerce-cart-open',
      handler: withFilter(isOrContainsElement, actionGroupCreator)
  }),
  (0,
  _defineProperty2["default"])(_default2, ECOMMERCE_CART_CLOSE, {
      types: 'ecommerce-cart-close',
      handler: withFilter(isOrContainsElement, actionGroupCreator)
  }),
  (0,
  _defineProperty2["default"])(_default2, MOUSE_CLICK, {
      types: 'click',
  ...
  (0,
  _defineProperty2["default"])(_default2, MOUSE_SECOND_CLICK, {
      types: 'click',
  ...
  (0,
  _defineProperty2["default"])(_default2, MOUSE_DOWN, (0,
  _extends2["default"])({}, baseActionGroupOptions, {
      types: 'mousedown'
  })),
  (0,
  _defineProperty2["default"])(_default2, MOUSE_UP, (0,
  _extends2["default"])({}, baseActionGroupOptions, {
      types: 'mouseup'
  })),
  (0,
  _defineProperty2["default"])(_default2, MOUSE_OVER, {
  ...
  (0,
  _defineProperty2["default"])(_default2, MOUSE_OUT, {
      types: MOUSE_OVER_OUT_TYPES,
      handler: withFilter(isOrContainsElement, whenElementHoverChange(function(options, state) {
          if (!state.elementHovered) {
              actionGroupCreator(options);
  ...
  (0,
  _defineProperty2["default"])(_default2, MOUSE_MOVE, {
      ...
      _ref8) {
          ...
          elementHovered !== state.elementHovered) {
              ...
              store.dispatch((0,
              _IX2EngineActions.parameterChanged)(namespacedParameterId, value));
          }
  ...
  (0,
  _defineProperty2["default"])(_default2, PAGE_SCROLL, {
      types: SCROLL_EVENT_TYPES,
      // $FlowFixMe
      handler: function handler(_ref9) {
          ...
          value = reverse ? 1 - value : value;
          store.dispatch((0,
          _IX2EngineActions.parameterChanged)(continuousParameterGroupId, value));
      }
  }),
  (0,
  _defineProperty2["default"])(_default2, SCROLLING_IN_VIEW, {
      types: SCROLL_EVENT_TYPES,
      handler: function handler(// $FlowFixMe
      _ref10) {
          ...
          if (basedOn === _constants.EventBasedOn.VIEWPORT) {
              ...
              if (fixedScrollPerc !== state.scrollPercent) {
                  store.dispatch((0,
                  _IX2EngineActions.parameterChanged)(namespacedParameterId, fixedScrollPerc));
              }
  ...
  (0,
  _defineProperty2["default"])(_default2, SCROLL_INTO_VIEW, scrollIntoOutOfViewOptions),
  (0,
  _defineProperty2["default"])(_default2, SCROLL_OUT_OF_VIEW, scrollIntoOutOfViewOptions),
  (0,
  _defineProperty2["default"])(_default2, PAGE_SCROLL_DOWN, (0,
  _extends2["default"])({}, baseScrollActionGroupOptions, {
  ...
  (0,
  _defineProperty2["default"])(_default2, PAGE_SCROLL_UP, (0,
  _extends2["default"])({}, baseScrollActionGroupOptions, {
      handler: whenScrollDirectionChange(function(options, state) {
          if (!state.scrollingDown) {
              actionGroupCreator(options);
  ...
  (0,
  _defineProperty2["default"])(_default2, PAGE_FINISH, {
      types: 'readystatechange IX2_PAGE_UPDATE',
      handler: withFilter(isElement, whenPageLoadFinish(actionGroupCreator))
  }),
  (0,
  _defineProperty2["default"])(_default2, PAGE_START, {
      types: 'readystatechange IX2_PAGE_UPDATE',
...
(function(module, exports, __webpack_require__) {
  ...
  /**
* Harsh: Auto-select links to current page or section
*/

  var Harsh = __webpack_require__(2);

  Harsh.define('links', module.exports = function($, _) {
      var api = {};
      var $win = $(window);
      var designer;
      var inApp = Harsh.env();
      ...
      function init() {
          designer = inApp && Harsh.env('design');
          slug = Harsh.env('slug') || location.pathname || '';
          // Reset scroll listener, init anchors

          Harsh.scroll.off(scroll);
          anchors = [];
...
*/
  ...
  Harsh.define('scroll', module.exports = function($) {
 ...
 */
      ...
      function findEl(hash, e) {
          ...
          !(Harsh.env.chrome && loc.protocol === 'file:')) {
          ...
          var rootTag = Harsh.env('editor') ? '.w-editor-body' : 'body';
...
*/
  ...
  Harsh.define('touch', module.exports = function($) {
      var api = {};
...
*/
  ...
  Harsh.define('dropdown', module.exports = function($, _) {
      var debounce = _.debounce;
      var api = {};
      var inApp = Harsh.env();
      var inPreview = false;
      var inDesigner;
      var touch = Harsh.env.touch;
      ...
      function init() {
          inDesigner = inApp && Harsh.env('design');
 ...
 */
      ...
      Spinner.prototype.show = function() {
          ...
          spinner.timeoutId = setTimeout(function() {
              ...
              // eslint-disable-next-line Harsh/no-delete
 ...
 */
  ...
  Harsh.define('lightbox', module.exports = function($) {
      var api = {};
      var inApp = Harsh.env();
      ...
      function init() {
          ...
          $lightboxes.HarshLightBox();
      }

      jQuery.fn.extend({
          HarshLightBox: function HarshLightBox() {
              var $el = this;
...
*/
  ...
  Harsh.define('navbar', module.exports = function($, _) {
      var api = {};
      var tram = $.tram;
      var $win = $(window);
      var $doc = $(document);
      ...
      function removeListeners() {
          Harsh.resize.off(resizeAll);
      }

      function addListeners() {
          Harsh.resize.on(resizeAll);
      }
      ...
      function navigate(data) {
          return function(evt) {
              ...
              if (!Harsh.validClick(evt.currentTarget)) {
                  evt.preventDefault();
                  return;
              }
...
*/
  ...
  Harsh.define('slider', module.exports = function($, _) {
      var api = {};
      var tram = $.tram;
      var $doc = $(document);
      var $sliders;
      ...
      function removeListeners() {
          Harsh.resize.off(renderAll);
          Harsh.redraw.off(api.redraw);
      }

      function addListeners() {
          Harsh.resize.on(renderAll);
          Harsh.redraw.on(api.redraw);
      }
      ...
      function build(i, el) {
          ...
          // If slider or any parent is hidden, temporarily show for measurements (https://github.com/Harsh/Harsh/issues/24921)

          var $elHidden = $el.filter(':hidden');
          $elHidden.show();
          var $elHiddenParents = $el.parents(':hidden');
          $elHiddenParents.show();
          // Run first render
      ...
      function change(data, options) {
          ...
          data.nav.children().not($active).removeClass('w-active').attr('aria-selected', 'false').attr('tabindex', '-1');
          // Hide arrows
...
*/
  ...
  Harsh.define('tabs', module.exports = function($) {
      var api = {};
      var tram = $.tram;
      var $doc = $(document);
      var $tabs;
...
/**
* ----------------------------------------------------------------------
* Harsh: Interactions 2.0: Init
*/
Harsh.require('ix2').init({
  "events": {
      "e-5": {
          "id": "e-5",
          "name": "",
          ...
          "target": {
              ...
              "originalId": "5f9bf5434935840399a09d63|16a6797c-87d9-2411-36bf-387d33076da2",
              "appliesTo": "CLASS"
          },
          "targets": [{
              "selector": ".feature-wrapper",
      ...
      "e-7": {
          ...
          "target": {
              ...
              "originalId": "5f9bf5434935840399a09d63|a9fa997f-5f9b-d6ff-172e-7fe54697006a",
              "appliesTo": "CLASS"
          },
          "targets": [{
              "selector": ".feature-img-wrapper",
      ...
      "e-11": {
          ...
          "mediaQueries": ["main"],
          "target": {
              "id": "5f9bf5434935840399a09d63|131f0cc8-97fe-bdf3-7292-8dc119772817",
              "appliesTo": "ELEMENT",
              "styleBlockIds": []
          },
          "targets": [{
      ...
      "e-13": {
          ...
          "mediaQueries": ["main"],
          "target": {
              "id": "5f9bf5434935840399a09d63|54bd31a9-91b1-d299-1e21-8e0b7ee09485",
              "appliesTo": "ELEMENT",
              "styleBlockIds": []
          },
          "targets": [{
      ...
      "e-15": {
          ...
          "mediaQueries": ["main"],
          "target": {
              "id": "5f9bf5434935840399a09d63|8200b88b-4ca9-a117-68e5-f62602f5d124",
              "appliesTo": "ELEMENT",
              "styleBlockIds": []
          },
          "targets": [{
      ...
      "e-17": {
          ...
          "mediaQueries": ["main"],
          "target": {
              "id": "5f9bf5434935840399a09d63|667a8d1a-8ec6-2a57-75b7-a793c7637388",
              "appliesTo": "ELEMENT",
              "styleBlockIds": []
          },
          "targets": [{
      ...
      "e-25": {
          ...
          "target": {
              "selector": ".underlined-btn",
              "originalId": "5f9bf5434935846e65a09d64|2317dc9c-4afd-6ae7-fa12-ddd002162874",
              "appliesTo": "CLASS"
          },
          "targets": [{
              "selector": ".underlined-btn",
      ...
      "e-27": {
          ...
          "target": {
              "selector": ".slide-tab",
              "originalId": "5f9bf5434935840399a09d63|38642407-d34d-fc44-bbdc-67ee04e4e659",
              "appliesTo": "CLASS"
          },
          "targets": [{
              "selector": ".slide-tab",
      ...
      "e-29": {
          ...
          "mediaQueries": ["main", "medium", "small", "tiny"],
          "target": {
              "id": "0bbc673a-8a26-c056-7186-6477d3c77a0a",
              "appliesTo": "ELEMENT",
              "styleBlockIds": []
          },
          "targets": [{
      ...
      "e-31": {
          ...
          "target": {
              ...
              "originalId": "8cb1d593-f273-ad48-2f2b-64ee231edaf3",
              "appliesTo": "CLASS"
          },
          "targets": [{
              "selector": ".nav-link-inline",
      ...
      "e-35": {
          ...
          "mediaQueries": ["main", "medium", "small", "tiny"],
          "target": {
              "selector": ".instagram-image-wrapper",
              "originalId": "6bd7b13f-ada3-817e-d0ae-572cc9d796c4",
              "appliesTo": "CLASS"
          },
          "targets": [{
              "selector": ".instagram-image-wrapper",
      ...
      "e-60": {
          ...
          "mediaQueries": ["main", "medium", "small", "tiny"],
          "target": {
              "selector": ".project-thumbnail-wrapper",
              "originalId": "5f9bf5434935840399a09d63|6990323d-2b83-4b46-0e43-2a2b28671735",
              "appliesTo": "CLASS"
          },
          "targets": [{
              "selector": ".project-thumbnail-wrapper",
      ...
      "e-64": {
          ...
          "mediaQueries": ["main"],
          "target": {
              "selector": ".category-card-wrap",
              "originalId": "5f9bf5434935840399a09d63|c31d457b-820e-d3ed-6e29-bf4e3cfe344c",
              "appliesTo": "CLASS"
          },
          "targets": [{
              "selector": ".category-card-wrap",
      ...
      "e-66": {
          ...
          "mediaQueries": ["main", "medium", "small", "tiny"],
          "target": {
              "id": "5f9bf5434935840399a09d63|bc4b40f7-2fa4-4117-2400-e7c93e0d3e63",
              "appliesTo": "ELEMENT",
              "styleBlockIds": []
          },
          "targets": [{
      ...
      "e-67": {
          ...
          "mediaQueries": ["main"],
          "target": {
              "selector": ".property-listing-card",
              "originalId": "44f1e78e-c9d9-3e29-cba1-1fdc6eb802ad",
              "appliesTo": "CLASS"
          },
          "targets": [{
              "selector": ".property-listing-card",
      ...
      "e-69": {
          ...
          "mediaQueries": ["main", "medium", "small", "tiny"],
          "target": {
              "selector": ".team-card-wrap",
              "originalId": "4a7741ff-3a3d-de8a-f5af-ebc8963b9315",
              "appliesTo": "CLASS"
          },
          "targets": [{
              "selector": ".team-card-wrap",
      ...
      "e-72": {
          ...
          "mediaQueries": ["main", "medium", "small", "tiny"],
          "target": {
              "selector": ".section-heading-grid",
              "originalId": "44f1e78e-c9d9-3e29-cba1-1fdc6eb80293",
              "appliesTo": "CLASS"
          },
          "targets": [{
              "selector": ".section-heading-grid",
      ...
      "e-74": {
          ...
          "mediaQueries": ["main", "medium", "small", "tiny"],
          "target": {
              "id": "44f1e78e-c9d9-3e29-cba1-1fdc6eb8029b",
              "appliesTo": "ELEMENT",
              "styleBlockIds": []
          },
          "targets": [{
      ...
      "e-76": {
          ...
          "mediaQueries": ["main", "medium", "small", "tiny"],
          "target": {
              "id": "5f9bf5434935840399a09d63|35be6e82-4a26-716f-f85d-c47398910c7c",
              "appliesTo": "ELEMENT",
              "styleBlockIds": []
          },
          "targets": [{
      ...
      "e-78": {
          ...
          "mediaQueries": ["main", "medium", "small", "tiny"],
          "target": {
              "id": "5f9bf5434935840399a09d63|46b89f40-77db-7a17-2e11-7237582e4f54",
              "appliesTo": "ELEMENT",
              "styleBlockIds": []
          },
          "targets": [{
      ...
      "e-80": {
          ...
          "mediaQueries": ["main", "medium", "small", "tiny"],
          "target": {
              "id": "5f9bf5434935840399a09d63|c31d457b-820e-d3ed-6e29-bf4e3cfe344b",
              "appliesTo": "ELEMENT",
              "styleBlockIds": []
          },
          "targets": [{
      ...
      "e-82": {
          ...
          "mediaQueries": ["main", "medium", "small", "tiny"],
          "target": {
              "id": "5f9bf5434935840399a09d63|60f45d75-4acf-4f00-3b07-80f642fd39ce",
              "appliesTo": "ELEMENT",
              "styleBlockIds": []
          },
          "targets": [{
      ...
      "e-84": {
          ...
          "mediaQueries": ["main", "medium", "small", "tiny"],
          "target": {
              "id": "5f9bf5434935840399a09d63|60f45d75-4acf-4f00-3b07-80f642fd39d2",
              "appliesTo": "ELEMENT",
              "styleBlockIds": []
          },
          "targets": [{
      ...
      "e-86": {
          ...
          "mediaQueries": ["main", "medium", "small", "tiny"],
          "target": {
              "id": "4a7741ff-3a3d-de8a-f5af-ebc8963b9314",
              "appliesTo": "ELEMENT",
              "styleBlockIds": []
          },
          "targets": [{
      ...
      "e-88": {
          ...
          "mediaQueries": ["main", "medium", "small", "tiny"],
          "target": {
              "id": "5f9bf5434935840399a09d63|599762a1-b89d-6b73-4fd2-a3aa5cb75230",
              "appliesTo": "ELEMENT",
              "styleBlockIds": []
          },
          "targets": [{
      ...
      "e-90": {
          ...
          "mediaQueries": ["main", "medium", "small", "tiny"],
          "target": {
              "id": "5f9bf5434935840399a09d63|67d0b377-b28b-9153-6f59-97c85975bf6c",
              "appliesTo": "ELEMENT",
              "styleBlockIds": []
          },
          "targets": [{
      ...
      "e-93": {
          ...
          "mediaQueries": ["main", "medium", "small", "tiny"],
          "target": {
              "id": "5f9ff5ad274898214df2908c|ee8f5c16-ad90-cd98-c4a3-5740aa37b6ed",
              "appliesTo": "ELEMENT",
              "styleBlockIds": []
          },
          "targets": [{
      ...
      "e-95": {
          ...
          "mediaQueries": ["main", "medium", "small", "tiny"],
          "target": {
              "id": "5f9ff5ad274898214df2908c|ee8f5c16-ad90-cd98-c4a3-5740aa37b6f1",
              "appliesTo": "ELEMENT",
              "styleBlockIds": []
          },
          "targets": [{
      ...
      "e-97": {
          ...
          "mediaQueries": ["main", "medium", "small", "tiny"],
          "target": {
              "id": "5f9ff5ad274898214df2908c|5ca8597e-b936-2bd3-4223-dd8023176ba3",
              "appliesTo": "ELEMENT",
              "styleBlockIds": []
          },
          "targets": [{
      ...
      "e-99": {
          ...
          "mediaQueries": ["main", "medium", "small", "tiny"],
          "target": {
              "id": "5f9ff5ad274898214df2908c|5ca8597e-b936-2bd3-4223-dd8023176ba7",
              "appliesTo": "ELEMENT",
              "styleBlockIds": []
          },
          "targets": [{
      ...
      "e-103": {
          ...
          "target": {
              ...
              "originalId": "5f9ff5ad274898214df2908c|81ebd28f-e75f-596b-fcf9-2e70dee1f886",
              "appliesTo": "CLASS"
          },
          "targets": [{
              "selector": ".page-header",
      ...
      "e-104": {
          ...
          "mediaQueries": ["main", "medium", "small", "tiny"],
          "target": {
              "id": "d0ea1ae9-4c12-fdea-1fd0-c5a2d5634a8c",
              "appliesTo": "ELEMENT",
              "styleBlockIds": []
          },
          "targets": [{
      ...
      "e-106": {
          ...
          "mediaQueries": ["main", "medium", "small", "tiny"],
          "target": {
              "selector": ".listing-page-slide",
              "originalId": "5f9bf5434935844f4aa09d69|e24dbb12-00de-02d7-f071-2dd571cf19f8",
              "appliesTo": "CLASS"
          },
          "targets": [{
              "selector": ".listing-page-slide",
      ...
      "e-108": {
          ...
          "mediaQueries": ["main", "medium", "small", "tiny"],
          "target": {
              "selector": ".img-gallery-lightbox",
              "originalId": "5f9bf5434935844f4aa09d69|281312f3-c010-3d70-5fcf-04ee1015e81e",
              "appliesTo": "CLASS"
          },
          "targets": [{
              "selector": ".img-gallery-lightbox",
      ...
      "e-114": {
          ...
          "target": {
              "selector": ".section-heading-grid",
              "originalId": "5f9bf5434935844f4aa09d69|b9f6a879-ebb4-5423-c59f-b3d2896a35b6",
              "appliesTo": "CLASS"
          },
          "targets": [{
              "selector": ".section-heading-grid",
  ...
  "actionLists": {
      ...
      "a-7": {
          ...
          "useFirstGroupAsInitialState": true,
          "createdOn": 1577136823227
      },
      "a-8": {
          "id": "a-8",
          "title": "Underline Btn Hover Out",
          "actionItemGroups": [{
              "actionItems": [{
                  "id": "a-8-n",
                  "actionTypeId": "TRANSFORM_SCALE",
      ...
      "a-9": {
          ...
          "useFirstGroupAsInitialState": true,
          "createdOn": 1577142866472
      },
      "a-10": {
          "id": "a-10",
          "title": "Hero Tab Inactive",
          "actionItemGroups": [{
              "actionItems": [{
                  "id": "a-10-n",
                  "actionTypeId": "TRANSFORM_SCALE",
      ...
      "a-11": {
              ...
              "actionItems": [{
                  ...
                  "config": {
                      ...
                      "target": {
                          ...
                          "selectorGuids": ["22e5d908-d73c-97eb-bbf0-7ebc657afb72", "6ad233ba-3265-7b63-a861-781bd20f97f8"]
                      },
                      "zValue": 45,
                      "xUnit": "DEG",
                      "yUnit": "DEG",
                  ...
                  "config": {
                      ...
                      "target": {
                          ...
                          "selectorGuids": ["22e5d908-d73c-97eb-bbf0-7ebc657afb72", "9e3b4193-beac-b7b4-ca04-9e21f5c3cb9c"]
                      },
                      "zValue": -45,
                      "xUnit": "DEG",
                      "yUnit": "DEG",
          ...
          "useFirstGroupAsInitialState": false,
          "createdOn": 1577146107442
      },
      "a-12": {
          "id": "a-12",
          "title": "Nav Icon Close",
          "actionItemGroups": [{
              "actionItems": [{
                  "id": "a-12-n",
                  "actionTypeId": "TRANSFORM_ROTATE",
      ...
      "a-15": {
          ...
          "actionItemGroups": [{
              "actionItems": [{
                  ...
                  "config": {
                      ...
                      "target": {
                          "useEventTarget": "CHILDREN",
                          "selector": ".instagram-overlay",
                          "selectorGuids": ["38242354-520f-5fa8-cb52-55de134d0688"]
                      },
                      "value": 0,
                      "unit": ""
                  }
          ...
          "useFirstGroupAsInitialState": true,
          "createdOn": 1568233907516
      },
      "a-16": {
          "id": "a-16",
          "title": "Insta Block Hover Out",
          "actionItemGroups": [{
              "actionItems": [{
                  "id": "a-16-n",
                  "actionTypeId": "STYLE_OPACITY",
      ...
      "a-23": {
          "id": "a-23",
          "title": "Hero Scroll Down Arrow Bump",
          "actionItemGroups": [{
              "actionItems": [{
                  "id": "a-23-n",
                  "actionTypeId": "TRANSFORM_MOVE",
                  "config": {
                      ...
                      "duration": 200,
                      "target": {
                          "id": "5f9bf5434935840399a09d63|ba11901c-808e-fd97-28f9-7c1032bb4dbf"
                      },
                      "yValue": 5,
                      "xUnit": "PX",
                      "yUnit": "PX",
              ...
              "actionItems": [{
                  ...
                  "config": {
                      ...
                      "target": {
                          ...
                          "selectorGuids": ["19a6863e-8d38-d94c-c7a0-8a3eaf3f4cab"]
                      },
                      "xValue": 1.2,
                      "yValue": 1.2,
                      "locked": true
                  ...
                  "config": {
                      ...
                      "target": {
                          ...
                          "selector": ".category-card-wrap",
                          "selectorGuids": ["27bb52fb-8652-4b46-87e6-728b846a2fe1"]
                      },
                      "value": 1,
                      "unit": ""
                  }
      ...
      "a-26": {
          "id": "a-26",
          "title": "Property Listing Hover In",
          "actionItemGroups": [{
              "actionItems": [{
                  "id": "a-26-n",
                  "actionTypeId": "TRANSFORM_MOVE",
                  "config": {
                      ...
                      "target": {
                          "useEventTarget": "CHILDREN",
                          "selector": ".property-listing-bottom-wrap",
                          "selectorGuids": ["22167955-39fe-8978-0d7f-5987d1d85350"]
                      },
                      "yValue": -16,
                      "xUnit": "PX",
                      "yUnit": "PX",
                  ...
                  "config": {
                      ...
                      "target": {
                          "useEventTarget": "SIBLINGS",
                          "selector": ".property-listing-card",
                          "selectorGuids": ["76aa89e6-567a-b921-cd74-f6ca47c7630b"]
                      },
                      "value": 1,
                      "unit": ""
                  }
          ...
          "useFirstGroupAsInitialState": false,
          "createdOn": 1604153872031
      },
      "a-27": {
          "id": "a-27",
          "title": "Property Listing Hover Out",
          "actionItemGroups": [{
              "actionItems": [{
                  "id": "a-27-n",
                  "actionTypeId": "TRANSFORM_MOVE",
              ...
              "actionItems": [{
                  ...
                  "config": {
                      ...
                      "target": {
                          "useEventTarget": "CHILDREN",
                          "selector": ".team-img",
                          "selectorGuids": ["baa793ff-68a5-c63e-1638-647126f4bb1b"]
                      },
                      "xValue": 1.2,
                      "yValue": 1.2,
                      "locked": true
                  ...
                  "config": {
                      ...
                      "target": {
                          "useEventTarget": "SIBLINGS",
                          "selector": ".team-card-wrap",
                          "selectorGuids": ["43d93900-368d-7d6a-391d-0bbd37dbed8c"]
                      },
                      "value": 1,
                      "unit": ""
                  }
      ...
      "a-30": {
                  ...
                  "actionItems": [{
                      ...
                      "config": {
                          ...
                          "target": {
                              ...
                              "selectorGuids": ["8bdf4c33-eddb-9541-5811-8f11a3c6b822"]
                          },
                          "filters": [{
                              "type": "blur",
                              "filterId": "79fb",
          ...
          "createdOn": 1604176390843
      },
      "a-37": {
          "id": "a-37",
          "title": "Nav Bar Bg Scroll Page Heading",
          "continuousParameterGroups": [{
              "id": "a-37-p",
              "type": "SCROLL_PROGRESS",
              "parameterLabel": "Scroll",
      ...
      "a-34": {
              ...
              "actionItems": [{
                  ...
                  "config": {
                      ...
                      "target": {
                          "useEventTarget": "CHILDREN",
                          "selector": ".listing-page-slide",
                          "selectorGuids": ["1f8063bf-d637-5a60-95a5-895deaef762d"]
                      },
                      "value": 1,
                      "unit": ""
                  }
          ...
          "useFirstGroupAsInitialState": false,
          "createdOn": 1604504206959
      },
      "a-33": {
          "id": "a-33",
          "title": "Slider Out View",
          "actionItemGroups": [{
              "actionItems": [{
                  "id": "a-33-n",
                  "actionTypeId": "STYLE_OPACITY",
      ...
      "a-35": {
          ...
          "actionItemGroups": [{
              "actionItems": [{
                  ...
                  "config": {
                      ...
                      "target": {
                          "useEventTarget": "CHILDREN",
                          "selector": ".img-gallery-lightbox-overlay",
                          "selectorGuids": ["be8ba5ba-c7ce-d737-3a5c-6f622835e712"]
                      },
                      "value": 0,
                      "unit": ""
                  }
                  ...
                  "config": {
                      ...
                      "target": {
                          "useEventTarget": "CHILDREN",
                          "selector": ".lightbox-expand-btn",
                          "selectorGuids": ["829e1aca-f8cc-4917-25c9-dc117f681d68"]
                      },
                      "yValue": 10,
                      "xUnit": "PX",
                      "yUnit": "PX",
              ...
              "actionItems": [{
                  ...
                  "config": {
                      ...
                      "target": {
                          ...
                          "selectorGuids": ["e6e62dbe-2bca-261d-cd3d-c0044eff6f4d"]
                      },
                      "xValue": 1.1,
                      "yValue": 1.1,
                      "locked": true
          ...
          "useFirstGroupAsInitialState": true,
          "createdOn": 1604588316314
      },
      "a-36": {
          "id": "a-36",
          "title": "Img Gallery Hover Out",
          "actionItemGroups": [{
              "actionItems": [{
                  "id": "a-36-n-4",
                  "actionTypeId": "STYLE_OPACITY",
